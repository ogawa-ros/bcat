...
class stage1_chopper_wheel(object):
    ...
    def chopper_wheel(self):
        ...
        spectrum_hot = [numpy.average(self.d.spectrum[hot_set[i]],axis=0) for i in range(len(hot_set)) ]
        ...
        spectrum_off = [numpy.average(self.d.spectrum[off_set[i]],axis=0) for i in range(len(off_set)) ]
